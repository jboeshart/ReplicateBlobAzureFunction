...
public static async Task<object> Run(HttpRequestMessage req, TraceWriter log)
{
    ...
    string sourceStorageConnectionStringKvUrl = "<replace with Key Vault secret identifier URL>";
    string destinationStorageConnectionStringKvUrl = "<replace with Key Vault secret identifier URL>";
